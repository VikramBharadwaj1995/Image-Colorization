...
def main(data_dir):
    ...
    for epoch in range(0, epochs):
        ...
        #Train
        val_dataloader, train_loss, train_psnr = trainer.train(data_directory=data_dir, current_epoch=epoch)
        training_loss.append(train_loss)
        training_psnr.append(train_psnr)
        
        # Validate
        model, current_loss, current_psnr = trainer.validate(val_dataloader=val_dataloader, current_epoch=epoch)
    ...
    plot_loss_psnr(training_loss,  training_psnr, validation_loss, validation_psnr)
